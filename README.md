...
Tasks
======
* Displaying reviews on a canvas as boxes, with graphical attributes that depend on the reviews  _V1 ALMOST DONE_
* Simple GUI  _V1 ALMOST DONE_
...
* data input scripts (reading review files, reviewer files, proposal info...)  _not highest priority_
* menus for mapping properties to graph attributes, and legend  _LET'S DO THIS, MMP to give you some real proposal rubrics_
